...
class Display() :
    ...
    def _order_num(self):
        ...
        text="Payment done.\n\nThanks for shopping!\n\nYour order number is "f'{a}'".\n\nThe order will be delievered."
        ...
        self.thank_screen.place(x=200,y=90,width=600,height=300)
    ...
    def _final(self) :
        ...
        pay_button.place(x=90,y=250,width=320,height=100)
